...
*/
int exec_subshell(parser_t &parser, const wcstring &cmd, std::vector<wcstring> &outputs, bool preserve_exit_status);
int exec_subshell(parser_t &parser, const wcstring &cmd, bool preserve_exit_status);
